...
namespace BookingApp.WPF.ViewModels.TouristVMs
{
    public class MyComplexTourRequestsViewModel
    {
        ...
        public MyComplexTourRequestsViewModel(MainViewModel mainViewModel, User loggedInUser) { 
        ...
        {
            MainViewModel.SwitchView(new AllRequestsInComplexTourRequestViewModel(MainViewModel, complexTourRequestDTO.TourRequests, LoggedInUser));
        }
